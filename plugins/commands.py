            ...
            if refData and refData.split("-", 1)[0] == "biisal":
                ...
                if AUTH_CHANNEL and await is_req_subscribed(client, message):
                        buttons = [[
                            ...
                            InlineKeyboardButton('⚙️ Fᴇᴀᴛᴜʀᴇꜱ', callback_data='features'),
                            ...
                            [
                            InlineKeyboardButton('Uᴘᴅᴀᴛᴇꜱ ✺', url='https://t.me/movie_update_channel0'),
